...
public class AddressBook {
    ...
    public String toString() {
        return "AddressBook [adressBookName=" + addressBookName + "]";
    }
    ...
    public String nameString = this.addressBookName + ".txt";

    public void write() {
        AddressBookFileIO.writeData(contactBook, this.addressBookName + ".txt");
    }

    public List<String> read() {
        return AddressBookFileIO.readDataFromFile(this.addressBookName);
    }
    ...
    public void writeDataToCSV() throws IOException, CsvRequiredFieldEmptyException, CsvDataTypeMismatchException {
        ...
        String fileName = "./" + this.addressBookName + "Contacts.csv";
